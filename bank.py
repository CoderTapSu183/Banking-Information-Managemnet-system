...
class Bank:
    ...
    def Registerrrr(self, name , ph , password, gender, age, address, num_acc, gmail):      # đăng ký  1
        cash = self.cash
        contitions = True
...
if __name__ == "__main__":
    ...
    if Admin == 2:   # đăng ký
        ...
        num_acc = print("")
        Bank_object.Registerrrr(name, ph, password, gender, age, address, num_acc, gmail)
